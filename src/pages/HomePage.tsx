...
export function HomePage() {
    ...
    const [showFilters, setShowFilters] = useState<boolean>(); // State that will set the visibility of the filter button
        ...
        fetch("/games.json")
            ...
            .then((data: GameProps[]) => {
                ...
                if (window.innerWidth <= 768) {
                    setShowFilters(false); // Mobile: hidden by default
                } else {
                    setShowFilters(true);  // Desktop: visible filters
                }
            });
    }, []);
    ...
    return (
        <div className="home-container">
            ...
            {/* State to control the visibility of the button to show filters in the mobile */}
            {showFilters && (
